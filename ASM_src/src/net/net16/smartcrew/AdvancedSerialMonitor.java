...
public class AdvancedSerialMonitor extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel12.setText("<html><p>Robert Hutter<br />Version 1204<br />No rights reserved.</p></html>");
    ...
    private void sendFileButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_sendFileButtonActionPerformed
        ...
        if (sendFile != null)
        {
            ...
            {
                log.append ("Can't send data. Port not open.\n");
    ...
    private void sendPrompt ()
    {
        try
            ...
            {
                log.append ("Can't send data. Please select another charset.\n");
            }
    }
